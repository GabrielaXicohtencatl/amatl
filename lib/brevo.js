...
/**
 * Envía un correo transaccional a ecosistemaamatl@gmail.com con el mensaje del formulario de contacto.
...
export async function sendContactEmail({ nombre, correo, asunto, mensaje }) {
  ...
  const res = await fetch(`${BREVO_API_URL}/smtp/email`, {
    ...
    body: JSON.stringify({
      sender: { name: 'Formulario AMATL', email: 'ecosistemaamatl@gmail.com' },
      to: [{ email: 'ecosistemaamatl@gmail.com' }],
